...
vim.keymap.set(
  "n",
  "<leader>cv",
  make_crates_handler("show_versions_popup"),
  make_opts("Show versions")
)
...
vim.keymap.set(
  "n",
  "<leader>cf",
  make_crates_handler("show_features_popup"),
  make_opts("Show features")
)
...
vim.keymap.set(
  "n",
  "<leader>cd",
  make_crates_handler("show_dependencies_popup"),
  make_opts("Show dependencies")
)
...
vim.keymap.set(
  "n",
  "<leader>cpa",
  make_crates_handler("update_all_crates"),
  make_opts("Update all crates")
)
...
vim.keymap.set(
  "v",
  "<leader>cU",
  make_crates_handler("upgrade_crates"),
  make_opts("Upgrade crates")
)
...
vim.keymap.set(
  "n",
  "<leader>cA",
  make_crates_handler("upgrade_all_crates"),
  make_opts("Upgrade all crates")
)
...
vim.keymap.set(
  "n",
  "<leader>cX",
  make_crates_handler("extract_crate_into_table"),
  make_opts("Extract crate to table")
)
...
vim.keymap.set(
  "n",
  "<leader>cR",
  make_crates_handler("open_repository"),
  make_opts("Open repository")
)
...
vim.keymap.set(
  "n",
  "<leader>cD",
  make_crates_handler("open_documentation"),
  make_opts("Open documentation")
)
...
vim.keymap.set(
  "n",
  "<leader>cC",
  make_crates_handler("open_crates_io"),
  make_opts("Open crates.io")
)
