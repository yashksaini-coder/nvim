...
vim.keymap.set(
  ...
  { desc = "Theme: Tokyonight (Default)" }
)
vim.keymap.set(
  "n",
  "<leader>cts",
  "<cmd>colorscheme tokyonight-storm<CR>",
  { desc = "Theme: Tokyonight Storm" }
)
vim.keymap.set(
  "n",
  "<leader>ctn",
  "<cmd>colorscheme tokyonight-night<CR>",
  { desc = "Theme: Tokyonight Night" }
)
vim.keymap.set(
  "n",
  "<leader>ctm",
  "<cmd>colorscheme tokyonight-moon<CR>",
  { desc = "Theme: Tokyonight Moon" }
)
vim.keymap.set(
  "n",
  "<leader>ctd",
  "<cmd>colorscheme tokyonight-day<CR>",
  { desc = "Theme: Tokyonight Day" }
)
...
-- Themery
vim.keymap.set("n", "<leader>T", "<cmd>Themery<CR>", { desc = "Theme: Open Themery" })
